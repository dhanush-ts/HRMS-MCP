...
@mcp.tool()
def get_all_meetings_for_employee(employee_id: str) -> List[Dict[str, str]]:
    """
...
def get_leave_history(emp_id: str) -> str:
    ...
    Args:
        emp_id (str): the employee ID for whom the leave history is being requested

    Returns:
        List[Dict[str, str]]: List of leave history entries
    """
